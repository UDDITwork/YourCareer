              ...
              <div className="px-4 pb-4 pt-2 space-y-4">
                ...
                <div className="space-y-1.5">
                  <div className="flex justify-between items-baseline">
                    <Label className="text-xs font-medium text-black uppercase tracking-wider">Technologies & Skills Used</Label>
                ...
                <div className="space-y-1.5">
                  <div className="flex justify-between items-baseline">
                    <Label className="text-xs font-medium text-black uppercase tracking-wider">Key Responsibilities & Achievements</Label>
                    <Button
                      variant="ghost"
                      size="sm"
                      onClick={() => {
